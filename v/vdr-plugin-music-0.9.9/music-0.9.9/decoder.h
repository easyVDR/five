...
private:
  ...
  bool FullFileExist(const char *FullFile);
protected:
...
//  void Modified(void) { modified=true; }
  ...
  bool SearchUp(const char *szArtist, const char *szTitle, const char *szGenre, const char *szFullFile, int szYearFrom, int szYearTo, int szRatingFrom, int szRatingTo, bool szPlayable);
  void Load(bool reload);
  bool Purge(void);
  void Empty(void);
  void Cache(cSongInfo *info, cFileInfo *file);
  void Update(int rating, cFileInfo *file);
