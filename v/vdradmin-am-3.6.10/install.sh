...
DESTDIR=${DESTDIR}
LIBDIR=${LIBDIR:-$DESTDIR/usr/share/vdradmin-am}
ETCDIR=${ETCDIR:-$DESTDIR/etc/vdradmin-am}
DOCDIR=${DOCDIR:-$DESTDIR/usr/share/doc/vdradmin-am}
BINDIR=${BINDIR:-$DESTDIR/usr/bin}
LOCDIR=${LOCDIR:-$DESTDIR/usr/share/locale}
MANDIR=${MANDIR:-$DESTDIR/usr/share/man}
LOGDIR=${LOGDIR:-$DESTDIR/var/log/vdradmin-am}
CACHEDIR=${CACHEDIR:-$DESTDIR/var/cache/vdradmin-am}
PIDFILE=${PIDFILE:-$DESTDIR/var/run/vdradmin-am/vdradmind.pid}
VIDEODIR=${VIDEODIR:-/media/easyvdr01/video0}
EPGIMAGES=${EPGIMAGES:-/var/cache/vdr/epgimages}
