...
BEGIN {
    ...
    $BASENAME = $1;
    $0 = $PROCNAME;
    unshift(@INC, "/usr/share/perl5/vdradmin-am");
...
$CONFIG{VDR_PORT}   = 6419; # will be set to 6419 in initial --config if locally installed VDR is >= 1.7.15
$CONFIG{SERVERHOST} = "0.0.0.0";
$CONFIG{SERVERPORT} = 7001;
$CONFIG{LOCAL_NET}  = "0.0.0.0/32";
$CONFIG{VIDEODIR}   = "/media/easyvdr01/video0";
...
#
$CONFIG{USERNAME}       = "easyvdr";
$CONFIG{PASSWORD}       = "easyvdr";
...
if (!$SEARCH_FILES_IN_SYSTEM) {
    ...
    $ETCDIR        = "/var/lib/vdradmin-am";
    $CERTSDIR      = "/etc/vdradmin-am/certs";
    $TEMPLATEDIR   = "/usr/share/vdradmin-am/template";
    $TEMPLATECACHE = "/var/cache/vdradmin-am";
    $LOGDIR        = "/var/log/vdradmin-am";
