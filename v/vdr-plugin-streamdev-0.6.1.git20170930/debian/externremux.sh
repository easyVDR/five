...
###
PROG=$(which ffmpeg)
[ -x ${PROG} ] || PROG='/usr/bin/ffmpeg'
# [ -x ${PROG} ] || PROG=$(which avconv)
# [ $NVENC -eq 1 ] && PROG='/home/mango/bin/ffmpeg'
...
case "$QUALITY" in
	DSL1000|dsl1000)   VBR="96K";   ABR="32K";  WIDTH=160; HEIGHT=90;;
	DSL2000|dsl2000)   VBR="128K";  ABR="32K";  WIDTH=160; HEIGHT=90;;
	DSL3000|dsl3000)   VBR="256K";  ABR="32K";  WIDTH=320; HEIGHT=180;;
	DSL6000|dsl6000)   VBR="378K";  ABR="64K";  WIDTH=320; HEIGHT=180;;
	DSL16000|dsl16000) VBR="768K";  ABR="64K"; WIDTH=480; HEIGHT=270;;
	WLAN11|wlan11)     VBR="1536K";  ABR="96K"; WIDTH=640; HEIGHT=360;;
